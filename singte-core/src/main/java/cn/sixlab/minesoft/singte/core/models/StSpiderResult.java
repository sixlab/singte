...
public class StSpiderResult extends BaseModel {
    ...
    @StColumn(text = "label.common.title", placeholder = "ph.spider.title", order = 50, cssClass = "required")
    private String title;

    @StColumn(text = "label.common.content", placeholder = "ph.spider.content", order = 60, cssClass = "required", viewable = false)
    private String content;

    @StColumn(text = "label.common.summary", placeholder = "ph.spider.summary", order = 70, cssClass = "required", viewable = false)
    private String summary;

    @StColumn(text = "label.common.category", placeholder = "ph.spider.category", order = 80, cssClass = "required", viewable = false)
    private String category;

    @StColumn(text = "label.common.keyword", placeholder = "ph.spider.keyword", order = 90, cssClass = "required", viewable = false)
